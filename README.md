...
Автор — QA engineer, специализация: автоматизация UI-тестирования на
Selenium/Playwright + pytest, Page Object Model. Опыт написания автотестов для
Angular SPA production-сервиса (двухэтапная авторизация, ожидания состояний
кнопок, перехват toast-уведомлений).
